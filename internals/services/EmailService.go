...
func (es *EmailService) ScheduleEmail(to []string, subject, body string, sendAt time.Time) error {
	// Delay execution until the specified time.
...
// Helper function to send emails with attachments. Encodes files as Base64 before sending.
// Parameters:
// - to: List of recipient email addresses.
// - subject: The subject of the email.
// - body: The body of the email (plain text or HTML).
...
// Helper function to send plain text or HTML emails.
// Parameters:
// - to: List of recipient email addresses.
// - subject: The subject of the email.
// - body: The body of the email (plain text or HTML).
...
// Helper function to read a file and return its content encoded in Base64 format.
// Parameters:
